...
public class MUL {
    ...
    public void mulFromMemoryRegister(short dest_address, short src_opcode) {
        short x = 0;
        switch (src_opcode) {
            case 0:
    ...
    public void mulFromRegisterInt(short dest_opcode, short src_opcode) {
        short x = 0;
        switch (dest_opcode) {
            case 0:
    ...
    public void mulFromRegisterMemory(short dest_opcode, short src_opcode) {
        short x = 0;
        switch (dest_opcode) {
            case 0:
    ...
    public void mulFromRegisterRegister(short dest_opcode, short src_opcode) {
        short x = 0;
