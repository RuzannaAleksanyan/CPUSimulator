...
public class OR {
    ...
    public void orFromMemoryRegister(short dest_address, short src_opcode) {
        short x = 0;
        switch (src_opcode) {
            case 0:
    ...
    public void orFromRegisterInt(short dest_opcode, short src_opcode) {
        short x = 0;
        switch (dest_opcode) {
            case 0:
    ...
    public void orFromRegisterMemory(short dest_opcode, short src_opcode) {
        short x = 0;
        switch (dest_opcode) {
            case 0:
    ...
    public void orFromRegisterRegister(short dest_opcode, short src_opcode) {
        short x = 0;
