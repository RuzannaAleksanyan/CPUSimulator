...
public class SUB {
    ...
    public void subtractFromMemoryRegister(short dest_address, short src_opcode) {
        short x = 0;
        switch (src_opcode) {
            case 0:
            ...
            case 1:
                ...
                break;
            case 2:
                x = (short) (RAM.memory[dest_address] - (short) reg.getGh());
                RAM.memory[dest_address] = x;
                flag(x);
                break;
            case 3:
    ...
    public void subtractFromRegisterInt(short dest_opcode, short src_opcode) {
        short x = 0;
        switch (dest_opcode) {
            case 0:
    ...
    public void subtractFromRegisterMemory(short dest_opcode, short src_opcode) {
        short x = 0;
        switch (dest_opcode) {
            case 0:
    ...
    public void subtractFromRegisterRegister(short dest_opcode, short src_opcode) {
        short x = 0;
