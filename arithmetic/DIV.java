...
public class DIV {
    ...
    public void divFromMemoryRegister(short dest_address, short src_opcode) {
        short x = 0;
        switch (src_opcode) {
            case 0:
    ...
    public void divFromRegisterInt(short dest_opcode, short src_opcode) {
        short x = 0;
        switch (dest_opcode) {
            case 0:
    ...
    public void divFromRegisterMemory(short dest_opcode, short src_opcode) {
        short x = 0;
        switch (dest_opcode) {
            case 0:
    ...
    public void divFromRegisterRegister(short dest_opcode, short src_opcode) {
        short x = 0;
